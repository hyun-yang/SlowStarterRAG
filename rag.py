...
def main():
    ...
    st.title("_Bookworm RAG :red[QA Chat]_ :books:")
    ...
    if 'messages' not in st.session_state:
        st.session_state['messages'] = [{"role": "assistant",
                                         "content": "Hello, If you have any questions about the document provided, please feel free to ask at any time!"}]
...
def get_conversation_chain(vetorstore, openai_api_key):
    ...
    conversation_chain = ConversationalRetrievalChain.from_llm(
        llm=llm,
        chain_type="stuff",
        retriever=vetorstore.as_retriever(search_type='mmr', vervose=True),
